#moduł wylicza parametry podkładek, w przypadku nie spełnienia warunku nośności, program ma zwiększyć wymiar a1
...
def funkcja_S65():  #zdefiniowanie funkcji 
    ...
    """
    obliczenia parametrów podkładki S65
    """

    global a1, b1, t, n, d, Fd, u, alfa #zmienne globalne !!!
